        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 780 }}>
          <Reveal>
            <div style={{
              ...
              Investment Research &middot; Published March 16, 2026 &middot; Updated June 23, 2026
            </div>
          </Reveal>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3" style={{ gap: 'var(--space-lg)' }}>
            ...
            <Reveal direction="left" delay={0.5}>
              <ParallaxLayer speed={1.7}>
                <TiltCard
                  ...
                  stats={[
                    { label: 'Episodes', value: '162' },
                    { label: 'Hours', value: '291.5' },
                    { label: 'Transcript sets', value: '9' },
                  ]}
                />
              </ParallaxLayer>
            </Reveal>
            ...
            <Reveal direction="right" delay={0.55}>
              <ParallaxLayer speed={1.8}>
                <TiltCard
                  href="/blog/semiconductor-ai-nodes"
                  label="Report X"
                  title="Semiconductor AI Nodes & Connections"
                  subtitle="A source-backed network report with 100 ranked AI semiconductor nodes, 2,422 relationship edges, depth-five paths, centrality maps, cash-flow caveats, and source trails."
                  accentColor="oklch(56% 0.15 255)"
                  stats={[
                    { label: 'Nodes', value: '100' },
                    { label: 'Edges', value: '2,422' },
                    { label: 'Paths', value: '500' },
                  ]}
                />
              </ParallaxLayer>
            </Reveal>
