...
const UNIVERSE_TABLE_HEADERS = [
  ...
  { label: 'Price', hint: 'Latest available public quote from the May 5, 2026 market-data refresh. Delisted names show no live quote.' },
    ...
    <main style={{ background: 'var(--surface-page)', minHeight: '100vh', paddingBottom: 'var(--space-4xl)' }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            Report VII &middot; Published April 9, 2026 &middot; Updated May 5, 2026
          </div>
          <h1
            className="font-display"
            style={{
                  ...
                  {filteredStocks.map((stock) => (
                    <tr key={stock.ticker_display} style={{ borderBottom: '1px solid var(--ink-100)' }}>
                      ...
                      <td style={{ padding: '14px 12px', color: 'var(--ink-700)', fontWeight: 600 }}>
                        <HoverExplain hint={stock.listing_status || `Latest price for ${stock.company} from the May 5, 2026 market-data refresh.`}>
