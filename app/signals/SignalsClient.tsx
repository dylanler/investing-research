...
const UNIVERSE_TABLE_HEADERS = [
  ...
  { label: 'Cases', hint: 'Dated bull, neutral, and bear cases from the June 9, 2026 agent audit.' },
  { label: 'Price', hint: 'Latest available public quote from the June 9, 2026 market-data refresh. Delisted names show no live quote.' },
    ...
    <main style={{ background: 'var(--surface-page)', minHeight: '100vh', paddingBottom: 'var(--space-4xl)' }}>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            Report VII &middot; Published April 9, 2026 &middot; Updated June 9, 2026
          </div>
          <h1
            className="font-display"
            style={{
                      ...
                      <td style={{ padding: '14px 12px', color: 'var(--ink-700)' }}>
                        <HoverExplain hint={`AI sensitivity ${stock.aiScore}/10. Higher means the stock is more directly levered to sustained AI demand.`}>
	                      ...
	                      <td style={{ padding: '14px 12px', color: 'var(--ink-700)', fontWeight: 600 }}>
	                        <HoverExplain hint={stock.listing_status || `Latest price for ${stock.company} from the June 9, 2026 market-data refresh.`}>
