...
export const scoringMetrics = [
  { key: 'm1', name: 'Data Scalability', short: 'Data' },
  { key: 'm2', name: 'Compute Scalability', short: 'Compute' },
  { key: 'm3', name: 'Task Generalization', short: 'Tasks' },
  { key: 'm4', name: 'Cross-Embodiment Transfer', short: 'Transfer' },
  { key: 'm5', name: 'Real-World Sample Efficiency', short: 'Efficiency' },
  { key: 'm6', name: 'Sim-to-Real Viability', short: 'Sim2Real' },
  { key: 'm7', name: 'Inference Speed', short: 'Speed' },
  { key: 'm8', name: 'Bitter Lesson Alignment', short: 'Bitter' },
];
