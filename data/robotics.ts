...
export const topAlpha: AlphaCompany[] = [
  { rank: 1, company: 'NVIDIA', type: 'Public', ticker: 'NVDA', alpha: 111, marketCap: '~$4.83T', keyFact: 'Cosmos 20M+ hrs, GR00T models, EgoScale, DreamDojo' },
  ...
  { rank: 4, company: 'Alphabet', type: 'Public', ticker: 'GOOGL', alpha: 108, marketCap: '~$4.01T', keyFact: 'RT-2, Open X-Embodiment, Gemini Robotics' },
  { rank: 5, company: 'Skild AI', type: 'Private', alpha: 107, valuation: '>$14B', keyFact: 'Omni-bodied intelligence, $1.7B+ raised' },
  { rank: 6, company: 'Amazon', type: 'Public', ticker: 'AMZN', alpha: 105, marketCap: '~$2.67T', keyFact: 'Warehouse robotics at scale + Digit deployment' },
  ...
  { rank: 9, company: 'Microsoft', type: 'Public', ticker: 'MSFT', alpha: 99, marketCap: '~$2.78T', keyFact: 'Azure robotics + OpenAI robotics alignment' },
...
export const publicCompanies: PublicCompany[] = [
  { company: 'NVIDIA', ticker: 'NVDA', country: 'US', marketCap: '~$4.83T', alpha: 111 },
  { company: 'Tesla', ticker: 'TSLA', country: 'US', marketCap: '~$1.46T', alpha: 111 },
  { company: 'Alphabet', ticker: 'GOOGL', country: 'US', marketCap: '~$4.01T', alpha: 108 },
  { company: 'Amazon', ticker: 'AMZN', country: 'US', marketCap: '~$2.67T', alpha: 105 },
  { company: 'Microsoft', ticker: 'MSFT', country: 'US', marketCap: '~$2.78T', alpha: 99 },
  { company: 'Symbotic', ticker: 'SYM', country: 'US', marketCap: '~$35.3B', alpha: 97 },
  { company: 'Hon Hai (Foxconn)', ticker: '2317.TW', country: 'Taiwan', marketCap: '$91.73B', alpha: 97 },
  { company: 'TSMC', ticker: 'TSM', country: 'Taiwan', marketCap: '~$1.94T', alpha: 92 },
  { company: 'Intuitive Surgical', ticker: 'ISRG', country: 'US', marketCap: '~$166.5B', alpha: 86 },
  { company: 'Hyundai Motor', ticker: '005380.KS', country: 'South Korea', marketCap: '$85B', alpha: 86 },
  { company: 'UBTECH Robotics', ticker: '9880.HK', country: 'China', marketCap: '$7.03B', alpha: 85 },
  { company: 'AMD', ticker: 'AMD', country: 'US', marketCap: '$334B', alpha: 80 },
  { company: 'Qualcomm', ticker: 'QCOM', country: 'US', marketCap: '$143B', alpha: 79 },
  { company: 'ABB', ticker: 'ABBN.SW', country: 'Switzerland', marketCap: '$168.03B', alpha: 79 },
  { company: 'Fanuc', ticker: '6954.T', country: 'Japan', marketCap: '$36.19B', alpha: 77 },
