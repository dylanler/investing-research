...
// Market-cap labels mirror the 2026-05-04 refresh in data/marketSnapshot.ts.
export const beneficiaryData: BeneficiaryCategory[] = [
  {
    ...
    icon: '🔬',
    companies: [
      { name: 'ASML Holding', ticker: 'ASML', marketCap: '~$550.0B', why: 'Sole EUV manufacturer. Projects $71B revenue by 2030.', isPublic: true },
      { name: 'KLA Corporation', ticker: 'KLAC', marketCap: '~$226.8B', why: 'Leading metrology/inspection. ~25% mask inspection market.', isPublic: true },
      { name: 'Lasertec', ticker: '6920.T', marketCap: '$10B', why: 'ONLY company making EUV mask inspection tools. Monopoly.', isPublic: true },
      { name: 'Applied Materials', ticker: 'AMAT', marketCap: '~$308.8B', why: 'Largest semi equipment maker. Deposition, etch, inspection.', isPublic: true },
      { name: 'Lam Research', ticker: 'LRCX', marketCap: '~$321.0B', why: 'Major etch/deposition. Benefits from increasing EUV layers.', isPublic: true },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Micron Technology', ticker: 'MU', marketCap: '~$583.2B', why: '#2 HBM. Revenue >$53B. HBM target $100B by 2028.', isPublic: true },
  ...
  },
  {
    ...
    icon: '📦',
    companies: [
      { name: 'TSMC', ticker: 'TSM', marketCap: '~$2.06T', why: 'Dominates CoWoS. 130K wafers/mo by end 2026. $52-56B capex.', isPublic: true },
  ...
  },
  {
    ...
    icon: '⚡',
    companies: [
      { name: 'GE Vernova', ticker: 'GEV', marketCap: '~$285.6B', why: 'Gas turbines = immediate stopgap. Revenue target $52B by 2028.', isPublic: true },
      { name: 'Constellation Energy', ticker: 'CEG', marketCap: '~$107.2B', why: 'Largest US nuclear fleet. Microsoft + Meta deals. +22.5% earnings growth.', isPublic: true },
      { name: 'Vistra Corp.', ticker: 'VST', marketCap: '~$52.6B', why: 'Largest unregulated US power producer. Amazon + Meta partnerships.', isPublic: true },
      ...
      { name: 'Quanta Services', ticker: 'PWR', marketCap: '~$111.4B', why: 'Largest power infrastructure contractor. $44B backlog (+27.5%).', isPublic: true },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'EMCOR Group', ticker: 'EME', marketCap: '~$40.2B', why: 'Largest US specialty contractor. Electrical/mechanical for DCs.', isPublic: true },
      ...
      { name: 'Comfort Systems USA', ticker: 'FIX', marketCap: '~$65.7B', why: 'Mechanical/electrical contracting for mission-critical facilities.', isPublic: true },
      { name: 'CoreWeave', ticker: 'CRWV', marketCap: '~$62.9B', why: 'Public neocloud. ~590 MW capacity. $55B backlog incl $14B Meta deal.', isPublic: true },
      ...
      { name: 'Nebius', ticker: 'NBIS', marketCap: '~$39.1B', why: 'Public European AI cloud. Nvidia invested $2B in March 2026.', isPublic: true },
  ...
  },
  {
    ...
    icon: '🧠',
    companies: [
      { name: 'Nvidia', ticker: 'NVDA', marketCap: '~$4.85T', why: 'Dominant AI GPU (86-92%). $215.9B FY2026. $500B+ backlog.', isPublic: true },
      { name: 'Broadcom', ticker: 'AVGO', marketCap: '~$2.00T', why: '70% custom ASIC market. AI backlog >$70B. Google TPU partner.', isPublic: true },
      { name: 'AMD', ticker: 'AMD', marketCap: '~$578.0B', why: '#2 AI GPU. Aggressive N2 bet. Major OpenAI deal.', isPublic: true },
      { name: 'Synopsys', ticker: 'SNPS', marketCap: '~$93.7B', why: '#1 EDA. AI-driven suite cuts 2nm design cycles ~12 months.', isPublic: true },
      { name: 'Cadence Design', ticker: 'CDNS', marketCap: '~$94.1B', why: '#2 EDA. AI reinforcement learning for chip design. Duopoly.', isPublic: true },
  ...
  },
  {
    ...
    icon: '🌐',
    companies: [
      { name: 'Arista Networks', ticker: 'ANET', marketCap: '~$217.5B', why: 'Dominates AI DC switching. AI revenue target $3.25B in 2026.', isPublic: true },
      { name: 'Amphenol', ticker: 'APH', marketCap: '~$174.9B', why: '~33% share in AI DC interconnects. Full-stack connectivity.', isPublic: true },
      ...
      { name: 'Astera Labs', ticker: 'ALAB', marketCap: '~$34.7B', why: 'Smart fabric switches. Scorpio launched 2026.', isPublic: true },
      { name: 'Applied Optoelectronics', ticker: 'AAOI', marketCap: '~$14.7B', why: '$4B 10yr Amazon deal. Revenue +82% YoY.', isPublic: true },
      { name: 'Fabrinet', ticker: 'FN', marketCap: '~$22.8B', why: 'Contract mfg for optical components. Benefits from all growth.', isPublic: true },
      { name: 'Lumentum', ticker: 'LITE', marketCap: '~$67.8B', why: 'Optical transceivers + lasers for hyperscale.', isPublic: true },
      { name: 'Ciena', ticker: 'CIEN', marketCap: '~$75.7B', why: 'Optical networking. 42% revenue from cloud providers.', isPublic: true },
  ...
  },
  {
    ...
    icon: '⚙️',
    companies: [
      { name: 'TSMC', ticker: 'TSM', marketCap: '~$2.06T', why: '60%+ foundry share. Only source for leading-edge 2nm/3nm at volume.', isPublic: true },
  ...
  },
  {
    ...
    icon: '👥',
    companies: [
      { name: 'ASML', ticker: 'ASML', marketCap: '~$550.0B', why: 'Must scale workforce for 60→150+ tools/year. Every engineer irreplaceable.', isPublic: true },
      { name: 'Applied Materials', ticker: 'AMAT', marketCap: '~$308.8B', why: 'Largest semi equipment co. Needs thousands more engineers.', isPublic: true },
      { name: 'Lam Research', ticker: 'LRCX', marketCap: '~$321.0B', why: 'Etch equipment scaling. Workforce expansion critical.', isPublic: true },
