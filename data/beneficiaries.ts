...
// Market-cap labels mirror the 2026-05-05 refresh in data/marketSnapshot.ts.
export const beneficiaryData: BeneficiaryCategory[] = [
  {
    ...
    icon: '🔬',
    companies: [
      { name: 'ASML Holding', ticker: 'ASML', marketCap: '~$534.3B', why: 'Sole EUV manufacturer. Projects $71B revenue by 2030.', isPublic: true },
      { name: 'KLA Corporation', ticker: 'KLAC', marketCap: '~$225.1B', why: 'Leading metrology/inspection. ~25% mask inspection market.', isPublic: true },
      { name: 'Lasertec', ticker: '6920.T', marketCap: '$10B', why: 'ONLY company making EUV mask inspection tools. Monopoly.', isPublic: true },
      { name: 'Applied Materials', ticker: 'AMAT', marketCap: '~$310.6B', why: 'Largest semi equipment maker. Deposition, etch, inspection.', isPublic: true },
      { name: 'Lam Research', ticker: 'LRCX', marketCap: '~$323.4B', why: 'Major etch/deposition. Benefits from increasing EUV layers.', isPublic: true },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Micron Technology', ticker: 'MU', marketCap: '~$650.1B', why: '#2 HBM. Revenue >$53B. HBM target $100B by 2028.', isPublic: true },
      ...
      { name: 'Rambus Inc.', ticker: 'RMBS', marketCap: '~$12.1B', why: 'Leading HBM controller IP. First HBM4E controller at 4.1TB/s.', isPublic: true },
      ...
      { name: 'Onto Innovation', ticker: 'ONTO', marketCap: '~$15.2B', why: 'Metrology/inspection for HBM die stacking.', isPublic: true },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Amkor Technology', ticker: 'AMKR', marketCap: '~$19.0B', why: '#2 OSAT. Building $2B Arizona mega-plant. Advanced products 80%+ revenue.', isPublic: true },
      ...
      { name: 'JCET Group', ticker: '600584.SS', marketCap: '~$11.8B', why: 'China\'s largest OSAT. #3 globally.', isPublic: true },
    ],
  },
  {
    id: 'energy',
    ...
    icon: '⚡',
    companies: [
      { name: 'GE Vernova', ticker: 'GEV', marketCap: '~$288.6B', why: 'Gas turbines = immediate stopgap. Revenue target $52B by 2028.', isPublic: true },
      { name: 'Constellation Energy', ticker: 'CEG', marketCap: '~$116.3B', why: 'Largest US nuclear fleet. Microsoft + Meta deals. +22.5% earnings growth.', isPublic: true },
      { name: 'Vistra Corp.', ticker: 'VST', marketCap: '~$54.5B', why: 'Largest unregulated US power producer. Amazon + Meta partnerships.', isPublic: true },
      { name: 'Eaton Corporation', ticker: 'ETN', marketCap: '~$165.1B', why: 'Global leader in switchgear/transformers. Acquired Boyd Thermal $9.5B.', isPublic: true },
      { name: 'Quanta Services', ticker: 'PWR', marketCap: '~$113.7B', why: 'Largest power infrastructure contractor. $44B backlog (+27.5%).', isPublic: true },
      { name: 'Oklo Inc.', ticker: 'OKLO', marketCap: '~$12.2B', why: '14GW pipeline. 12GW Switch deal. Sam Altman is chairman.', isPublic: true },
  ...
  },
  {
    ...
    icon: '🏗️',
    companies: [
      { name: 'Vertiv Holdings', ticker: 'VRT', marketCap: '~$117.6B', why: 'Leading thermal management + power distribution. 28% organic growth.', isPublic: true },
      { name: 'EMCOR Group', ticker: 'EME', marketCap: '~$41.6B', why: 'Largest US specialty contractor. Electrical/mechanical for DCs.', isPublic: true },
      { name: 'Schneider Electric', ticker: 'SU.PA', marketCap: '$130B', why: 'Global leader in DC power management + automation.', isPublic: true },
      { name: 'Equinix', ticker: 'EQIX', marketCap: '~$107.0B', why: 'Largest DC REIT. Building AI-optimized facilities globally.', isPublic: true },
      ...
      { name: 'CoreWeave', ticker: 'CRWV', marketCap: '~$66.3B', why: 'Public neocloud. ~590 MW capacity. $55B backlog incl $14B Meta deal.', isPublic: true },
      ...
      { name: 'Nebius', ticker: 'NBIS', marketCap: '~$44.7B', why: 'Public European AI cloud. Nvidia invested $2B in March 2026.', isPublic: true },
  ...
  },
  {
    ...
    icon: '🧠',
    companies: [
      { name: 'Nvidia', ticker: 'NVDA', marketCap: '~$4.82T', why: 'Dominant AI GPU (86-92%). $215.9B FY2026. $500B+ backlog.', isPublic: true },
      { name: 'Broadcom', ticker: 'AVGO', marketCap: '~$1.97T', why: '70% custom ASIC market. AI backlog >$70B. Google TPU partner.', isPublic: true },
      { name: 'AMD', ticker: 'AMD', marketCap: '~$556.9B', why: '#2 AI GPU. Aggressive N2 bet. Major OpenAI deal.', isPublic: true },
      { name: 'Synopsys', ticker: 'SNPS', marketCap: '~$96.3B', why: '#1 EDA. AI-driven suite cuts 2nm design cycles ~12 months.', isPublic: true },
  ...
  },
  {
    ...
    icon: '🌐',
    companies: [
      { name: 'Arista Networks', ticker: 'ANET', marketCap: '~$217.4B', why: 'Dominates AI DC switching. AI revenue target $3.25B in 2026.', isPublic: true },
      { name: 'Amphenol', ticker: 'APH', marketCap: '~$174.8B', why: '~33% share in AI DC interconnects. Full-stack connectivity.', isPublic: true },
      { name: 'Coherent Corp.', ticker: 'COHR', marketCap: '~$61.8B', why: 'Optical transceivers (800G/1.6T), lasers, photonic components.', isPublic: true },
      { name: 'Credo Technology', ticker: 'CRDO', marketCap: '~$34.0B', why: '88% AEC market share. Revenue doubling to ~$1B.', isPublic: true },
      { name: 'Astera Labs', ticker: 'ALAB', marketCap: '~$36.9B', why: 'Smart fabric switches. Scorpio launched 2026.', isPublic: true },
      { name: 'Applied Optoelectronics', ticker: 'AAOI', marketCap: '~$14.5B', why: '$4B 10yr Amazon deal. Revenue +82% YoY.', isPublic: true },
      { name: 'Fabrinet', ticker: 'FN', marketCap: '~$23.7B', why: 'Contract mfg for optical components. Benefits from all growth.', isPublic: true },
      { name: 'Lumentum', ticker: 'LITE', marketCap: '~$69.7B', why: 'Optical transceivers + lasers for hyperscale.', isPublic: true },
      { name: 'Ciena', ticker: 'CIEN', marketCap: '~$76.1B', why: 'Optical networking. 42% revenue from cloud providers.', isPublic: true },
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'GlobalFoundries', ticker: 'GFS', marketCap: '~$35.6B', why: 'Leading mature-node. Essential for power/analog/connectivity.', isPublic: true },
      ...
      { name: 'Entegris', ticker: 'ENTG', marketCap: '~$21.7B', why: 'Specialty chemicals, filters, materials. Critical purity enabler.', isPublic: true },
  ...
  },
  {
    ...
    icon: '👥',
    companies: [
      { name: 'ASML', ticker: 'ASML', marketCap: '~$534.3B', why: 'Must scale workforce for 60→150+ tools/year. Every engineer irreplaceable.', isPublic: true },
      { name: 'Applied Materials', ticker: 'AMAT', marketCap: '~$310.6B', why: 'Largest semi equipment co. Needs thousands more engineers.', isPublic: true },
      { name: 'Lam Research', ticker: 'LRCX', marketCap: '~$323.4B', why: 'Etch equipment scaling. Workforce expansion critical.', isPublic: true },
