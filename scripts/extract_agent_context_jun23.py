#!/usr/bin/env python3
"""Build compact per-symbol and per-page context files for the June 23 research agents.

Outputs:
  tmp/agent-context-2026-06-23/symbols/<safe_symbol>.json  - one file per market symbol
  tmp/agent-context-2026-06-23/pages/<page>.json           - full compact ranked list per page
  tmp/agent-context-2026-06-23/universe.json               - exclusion list for discovery agents
  tmp/agent-context-2026-06-23/movers.json                 - biggest June 8 -> June 9 moves
"""
...
OUT = ROOT / "tmp" / "agent-context-2026-06-23"
...
m9 = load_market("2026-06-23")
m8 = load_market("2026-06-09")
